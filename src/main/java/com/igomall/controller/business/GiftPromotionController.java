...
public class GiftPromotionController extends BaseController {
	...
	public void populateModel(Long promotionId, Long giftAttributeId, @CurrentStore Store currentStore, ModelMap model) {
		...
		GiftAttribute giftAttribute = (GiftAttribute) promotionDefaultAttributeService.find(giftAttributeId);
	 ...
	 */
	@PostMapping("/save")
	public ResponseEntity<?> save(@ModelAttribute("promotionForm") Promotion promotionForm, @ModelAttribute("giftAttributeForm") GiftAttribute giftAttributeForm, Long[] giftIds, Long[] memberRankIds, @CurrentStore Store currentStore) {
	 ...
	 */
	@PostMapping("/update")
	public ResponseEntity<?> update(@ModelAttribute("promotionForm") Promotion promotionForm, @ModelAttribute(binding = false) Promotion promotion, @ModelAttribute("giftAttributeForm") GiftAttribute giftAttributeForm,
			@ModelAttribute(binding = false) GiftAttribute giftAttribute, Long[] giftIds, Long[] memberRankIds) {
		if (promotion == null) {
			return Results.UNPROCESSABLE_ENTITY;
		}
