...
public interface OrderDao extends BaseDao<Order> {
	 ...
	 * @return 订单分页
	 */
	List<Order> findPage(IPage<Order> iPage, @Param("ew")QueryWrapper<Order> queryWrapper, @Param("type")Order.Type type, @Param("status")Order.Status status, @Param("store")Store store, @Param("member")Member member, @Param("product")Product product, @Param("isPendingReceive")Boolean isPendingReceive, @Param("isPendingRefunds")Boolean isPendingRefunds, @Param("isUseCouponCode")Boolean isUseCouponCode, @Param("isExchangePoint")Boolean isExchangePoint, @Param("isAllocatedStock")Boolean isAllocatedStock, @Param("hasExpired")Boolean hasExpired);
	 ...
	 * @return 已发放佣金总额
	 */
	BigDecimal grantedCommissionTotalAmount(@Param("store")Store store, @Param("commissionType") Order.CommissionType commissionType, @Param("beginDate")Date beginDate, @Param("endDate")Date endDate, @Param("statuses")Order.Status... statuses);
