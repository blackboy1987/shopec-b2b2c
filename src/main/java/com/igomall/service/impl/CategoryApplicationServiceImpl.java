...
import com.igomall.entity.ProductCategoryStore;
...
import com.igomall.dao.ProductCategoryStoreDao;
...
public class CategoryApplicationServiceImpl extends BaseServiceImpl<CategoryApplication> implements CategoryApplicationService {
	...
	@Override
	public Long count(CategoryApplication.Status status, Long storeId, Long productCategoryId) {
