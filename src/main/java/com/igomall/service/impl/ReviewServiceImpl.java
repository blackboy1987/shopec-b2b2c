...
public class ReviewServiceImpl extends BaseServiceImpl<Review> implements ReviewService {
	...
	@Override
	public Long count(Long memberId, Long productId, Review.Type type, Boolean isShow) {
		Member member = memberDao.find(memberId);
		if (memberId != null && member == null) {
			return 0L;
		}
	...
	public void create(com.igomall.entity.Order order, List<Review.Entry> reviewEntries, String ip, Member memebr) {
