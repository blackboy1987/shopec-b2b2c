...
public class ExcelView extends AbstractView {
	...
	static {
		...
		try {
			File shopecPropertiesFile = ResourceUtils.getFile(CommonAttributes.SHOPEC_PROPERTIES_PATH);
			properties = PropertiesLoaderUtils.loadProperties(new FileSystemResource(shopecPropertiesFile));
		} catch (IOException e) {
