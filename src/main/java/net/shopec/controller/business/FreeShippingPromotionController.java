...
import net.shopec.entity.FreeShippingAttribute;
...
public class FreeShippingPromotionController extends BaseController {
	...
	public void populateModel(Long promotionId, Long freeShippingAttributeId, @CurrentStore Store currentStore, ModelMap model) {
		...
		FreeShippingAttribute freeShippingAttribute = (FreeShippingAttribute) promotionDefaultAttributeService.find(freeShippingAttributeId);
	 ...
	 */
	@PostMapping("/save")
	public ResponseEntity<?> save(@ModelAttribute("promotionForm") Promotion promotionForm, @ModelAttribute("giftAttributeForm") FreeShippingAttribute giftAttributeForm, Long[] memberRankIds, @CurrentStore Store currentStore) {
	 ...
	 */
	@PostMapping("/update")
	public ResponseEntity<?> update(@ModelAttribute("promotionForm") Promotion promotionForm, @ModelAttribute(binding = false) Promotion promotion, @ModelAttribute("freeShippingAttributeForm") FreeShippingAttribute freeShippingAttributeForm,
			@ModelAttribute(binding = false) FreeShippingAttribute freeShippingAttribute, Long[] memberRankIds) {
		if (promotion == null) {
			return Results.UNPROCESSABLE_ENTITY;
		}
