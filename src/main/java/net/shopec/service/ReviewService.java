...
public interface ReviewService extends BaseService<Review> {
	 ...
	 * @return 评论
	 */
	List<Review> findList(Member member, Product product, Review.Type type, Boolean isShow, Integer count, List<Filter> filters, List<net.shopec.Order> orders);
	 ...
	 * @return 评论
	 */
	List<Review> findList(Long memberId, Long productId, Review.Type type, Boolean isShow, Integer count, List<Filter> filters, List<net.shopec.Order> orders, boolean useCache);
