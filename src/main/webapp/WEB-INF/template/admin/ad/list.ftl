							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="adPositionId">
									...
									<tbody>
										[#list page.content as ad]
											<tr>
												...
												<td>
													[#if ad.beginDate??]
														<span title="${ad.beginDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${ad.beginDate?string("yyyy-MM-dd HH:mm:ss")}</span>
													[#else]
														-
													[/#if]
												</td>
												<td>
													[#if ad.endDate??]
														<span title="${ad.endDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${ad.endDate?string("yyyy-MM-dd HH:mm:ss")}</span>
													[#else]
														-
													[/#if]
												</td>
