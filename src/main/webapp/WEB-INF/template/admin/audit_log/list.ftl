							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="userId">
									...
									<tbody>
										[#list page.content as auditLog]
											<tr>
												...
												<td>
													<span title="${auditLog.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${auditLog.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
												</td>
												<td>
