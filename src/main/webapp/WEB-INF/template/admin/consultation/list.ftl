							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="productId">
									...
									<tbody>
										[#list page.content as consultation]
											<tr>
												...
												<td>
													<span title="${consultation.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${consultation.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
												</td>
												<td>
