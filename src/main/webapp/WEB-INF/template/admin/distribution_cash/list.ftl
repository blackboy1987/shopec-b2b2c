...
<head>
	...
	<title>${message("admin.distributionCash.list")} - Powered By SHOPEC</title>
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="distributorId">
									...
									<tbody>
										[#list page.content as distributionCash]
											<tr[#if !distributionCash_has_next] class="last"[/#if]>
												...
												<td>
													<span title="${distributionCash.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${distributionCash.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
												</td>
												<td>
