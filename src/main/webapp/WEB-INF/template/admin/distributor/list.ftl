...
<head>
	...
	<title>${message("admin.distributor.list")} - Powered By SHOPEC</title>
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="parentId">
									...
									<tbody>
										[#list page.content as distributor]
											<tr>
												...
												<td>
													<span title="${distributor.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${distributor.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
												</td>
												<td>
