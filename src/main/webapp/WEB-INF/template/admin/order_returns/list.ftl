								...
								<div id="search" class="input-group">
									<div class="input-group-btn">
										...
										<ul class="dropdown-menu">
											...
											<li[#if page.searchProperty == "trackingNo"] class="active"[/#if] data-search-property="tracking_no">
											...
											<li[#if page.searchProperty == "area"] class="active"[/#if] data-search-property="area_id">
											...
											<li[#if page.searchProperty == "zipCode"] class="active"[/#if] data-search-property="zip_code">
									...
									<tbody>
										[#list page.content as returns]
											<tr>
												...
												<td>
													<span title="${returns.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${returns.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
												</td>
												<td>
