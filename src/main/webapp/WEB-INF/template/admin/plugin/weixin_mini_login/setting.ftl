...
<head>
	...
	<title>${message("admin.plugin.weixinMiniLogin.setting")} - Powered By SHOPEC</title>
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.plugin.weixinMiniLogin.setting")}</li>
			</ol>
			<form id="weixinLoginForm" class="ajax-form form-horizontal" action="${base}/admin/plugin/weixin_mini_login/update" method="post">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="appId">${message("admin.plugin.weixinMiniLogin.appId")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="appId" name="appId" class="form-control" type="text" value="${pluginConfig.getAttribute("appId")}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="appSecret">${message("admin.plugin.weixinMiniLogin.appSecret")}:</label>
							<div class="col-xs-9 col-sm-4">
