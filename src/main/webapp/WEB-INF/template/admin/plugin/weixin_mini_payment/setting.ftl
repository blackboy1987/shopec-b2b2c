...
<head>
	...
	<title>${message("admin.plugin.weixinMiniPayment.setting")} - Powered By SHOPEC</title>
	...
	[#noautoesc]
		[#escape x as x?js_string]
			...
			$().ready(function() {
				...
				var $weixinMiniPaymentForm = $("#weixinMiniPaymentForm");
				
				// 表单验证
				$weixinMiniPaymentForm.validate({
					rules: {
	...
	<main>
		<div class="container-fluid">
			<ol class="breadcrumb">
				...
				<li class="active">${message("admin.plugin.weixinMiniPayment.setting")}</li>
			</ol>
			<form id="weixinMiniPaymentForm" class="ajax-form form-horizontal" action="${base}/admin/plugin/weixin_mini_payment/update" method="post">
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="appId">${message("admin.plugin.weixinMiniPayment.appId")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="appId" name="appId" class="form-control" type="text" value="${pluginConfig.getAttribute("appId")}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="appSecret">${message("admin.plugin.weixinMiniPayment.appSecret")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="appSecret" name="appSecret" class="form-control" type="text" value="${pluginConfig.getAttribute("appSecret")}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="mchId">${message("admin.plugin.weixinMiniPayment.mchId")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="mchId" name="mchId" class="form-control" type="text" value="${pluginConfig.getAttribute("mchId")}" maxlength="200">
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label item-required" for="apiKey">${message("admin.plugin.weixinMiniPayment.apiKey")}:</label>
							<div class="col-xs-9 col-sm-4">
