			...
			<form id="productCategoryForm" class="ajax-form form-horizontal" action="${base}/admin/product_category/update" method="post">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<!-- 图片上传 -->
						<div class="form-group">
							<label class="col-xs-3 col-sm-2 control-label" for="image">${message("ProductCategory.image")}:</label>
							<div class="col-xs-9 col-sm-4">
								<input id="image" name="image" type="hidden" class="form-control" value="${productCategory.image}" data-provide="fileinput" data-file-type="IMAGE">
							</div>
						</div>
						<div class="form-group">
