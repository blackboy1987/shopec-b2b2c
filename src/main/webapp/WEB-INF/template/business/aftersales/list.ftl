...
<head>
	...
	<title>${message("business.aftersales.list")} - Powered By SHOPEC</title>
									...
									<tbody>
										[#list page.content as aftersales]
											<tr>
												...
												<td>
													<span title="${aftersales.createdDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${aftersales.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
												</td>
												<td>
