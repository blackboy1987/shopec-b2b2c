							...
							<div class="col-xs-12 col-sm-3">
								<div id="search" class="input-group">
									<div class="input-group-btn">
										...
										<ul class="dropdown-menu">
											<li[#if !page.searchProperty?? || page.searchProperty == "coupon.name"] class="active"[/#if] data-search-property="coupon.name">
									...
									<tbody>
										[#list page.content as coupon]
											<tr>
												...
												<td>
													[#if coupon.beginDate??]
														<span title="${coupon.beginDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${coupon.beginDate?string("yyyy-MM-dd HH:mm:ss")}</span>
													[#else]
														-
													[/#if]
												</td>
												<td>
													[#if coupon.endDate??]
														<span title="${coupon.endDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${coupon.endDate?string("yyyy-MM-dd HH:mm:ss")}</span>
													[#else]
														-
													[/#if]
												</td>
