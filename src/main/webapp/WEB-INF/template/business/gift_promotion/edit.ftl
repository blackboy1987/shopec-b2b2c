...
<head>
	...
	<title>${message("business.giftPromotionPlugin.edit")} - Powered By SHOPEC</title>
					...
					<div class="panel-body">
						...
						<div class="tab-content">
							<div id="base" class="tab-pane active">
								...
								<div class="form-group">
									<label class="col-xs-3 col-sm-2 control-label item-required">${message("Promotion.gifts")}:</label>
									<div class="col-xs-9 col-sm-4">
