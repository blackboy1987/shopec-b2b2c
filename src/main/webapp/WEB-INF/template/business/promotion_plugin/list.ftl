...
<head>
	...
	<title>${message("business." + promotionPlugin.id + ".list")} - Powered By SHOPEC</title>
							...
							<div class="col-xs-12 col-sm-3">
								<div id="search" class="input-group">
									<div class="input-group-btn">
										...
										<ul class="dropdown-menu">
											<li[#if !page.searchProperty?? || page.searchProperty == "promotion.name"] class="active"[/#if] data-search-property="promotion.name">
											...
											<tr>
												...
												<td>
													[#if promotion.beginDate??]
														<span title="${promotion.beginDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${promotion.beginDate?string("yyyy-MM-dd HH:mm:ss")}</span>
													[#else]
														-
													[/#if]
												</td>
												<td>
													[#if promotion.endDate??]
														<span title="${promotion.endDate?string("yyyy-MM-dd HH:mm:ss")}" data-toggle="tooltip">${promotion.endDate?string("yyyy-MM-dd HH:mm:ss")}</span>
													[#else]
														-
													[/#if]
												</td>
