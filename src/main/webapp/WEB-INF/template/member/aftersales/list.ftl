...
<head>
	...
	<title>${message("member.aftersales.list")} - Powered By SHOPEC</title>
												...
												<div class="media-body media-middle">
													<ul>
														...
														<li>
															...
															<span class="text-gray" title="${aftersales.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${aftersales.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
														</li>
													</ul>
												</div>
