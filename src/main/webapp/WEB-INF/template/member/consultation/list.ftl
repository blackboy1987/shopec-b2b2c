...
<head>
	...
	<title>${message("member.consultation.list")} - Powered By SHOPEC</title>
												...
												<div class="media-left media-middle">
													<div class="media">
														...
														<div class="media-body media-middle">
															...
															<p class="text-gray-dark small" title="${consultation.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${consultation.createdDate?string("yyyy-MM-dd HH:mm:ss")}</p>
														</div>
													</div>
												</div>
												<div class="media-body media-middle">
