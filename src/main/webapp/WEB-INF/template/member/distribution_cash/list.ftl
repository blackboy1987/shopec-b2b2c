...
<head>
	...
	<title>${message("member.distributionCash.list")} - Powered By SHOPEC</title>
										...
										<tbody>
											[#list page.content as distributionCash]
												<tr>
													...
													<td>
														<span title="${distributionCash.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${distributionCash.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
													</td>
												</tr>
											[/#list]
										</tbody>
