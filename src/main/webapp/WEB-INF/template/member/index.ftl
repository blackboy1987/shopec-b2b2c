...
<head>
	...
	<title>${message("member.index.title")} - Powered By SHOPEC</title>
											...
											<div class="media-body media-middle">
												<ul>
													...
													<li>
														...
														<span class="text-gray" title="${order.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${order.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
													</li>
												</ul>
											</div>
