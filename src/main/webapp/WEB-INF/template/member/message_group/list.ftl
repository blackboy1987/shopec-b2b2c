...
<head>
	...
	<title>${message("member.messageGroup.list")} - Powered By SHOPEC</title>
										...
										<tbody>
											[#list page.content as messageGroup]
												<tr>
													...
													<td>
														<span title="${messageGroup.lastModifiedDate?string("yyyy-MM-dd HH:mm:ss")}">${messageGroup.lastModifiedDate?string("yyyy-MM-dd HH:mm:ss")}</span>
													</td>
													<td>
