...
<head>
	...
	<title>${message("member.review.list")} - Powered By SHOPEC</title>
												...
												<div class="media-left media-middle">
													<div class="media">
														...
														<div class="media-body media-middle">
															...
															[/#if]
															<p class="text-gray-dark small" title="${review.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${review.createdDate?string("yyyy-MM-dd HH:mm:ss")}</p>
														</div>
													</div>
												</div>
												<div class="media-body media-middle">
